...
var _propInput = function(model, prop, propAccessor, editType, widgets) {
  ...
  if (typeof widgets !== 'undefined' && typeof widgets[widget] !== 'undefined') {
    ...
    html += '<a class="ui-textbutton-button" data-bind="visible: typeof $root.linkDialog !== \'undefined\', click: typeof $root.linkDialog !== \'undefined\' ? $root.linkDialog.bind($element.previousSibling) : false, button: { icons: { primary: \'fa fa-fw fa-ellipsis-h\' }, label: \'Options\', text: false }">Options</a>';
    html += '</div>';
